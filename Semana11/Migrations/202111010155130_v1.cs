namespace Semana11.Migrations
{
    ...
    public partial class v1 : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Deparment_DepartmentID = c.Int(),
                    })
                .PrimaryKey(t => t.CourseID)
                .ForeignKey("dbo.Departments", t => t.Deparment_DepartmentID)
                .Index(t => t.Deparment_DepartmentID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Courses", "Deparment_DepartmentID", "dbo.Departments");
            ...
            DropIndex("dbo.Courses", new[] { "Deparment_DepartmentID" });
